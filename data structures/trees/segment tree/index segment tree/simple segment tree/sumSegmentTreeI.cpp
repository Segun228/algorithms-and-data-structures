    ...
    public:
        ...
        private:
            int sendRequest(int l, int r, int leftSelf, int rightSelf, int myIndex){
                ...
                return (sendRequest(l, r, leftSelf, (leftSelf+rightSelf)/2, (myIndex*2 + 1)) + sendRequest(l, r, ((leftSelf+rightSelf)/2)+1, rightSelf, (myIndex*2 + 2)));
            }
};
